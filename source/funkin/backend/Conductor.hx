...
class Conductor
{
	...
	public static var safeZoneOffset:Float = (funkin.backend.utils.ClientPrefs.data.safeFrames / 60) * 1000; // is calculated in create(), is safeFrames in milliseconds
	...
	public static function mapBPMChanges(song:SwagSong)
	{
		...
		trace("Cutie Loaded Up A New Juicy BPM Map " + bpmChangeMap);
	}
