...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		if(!ClientPrefs.data.botplayStudio){
			cpuControlled = false;
		} else {
			cpuControlled = true;
		};
	...
	//	timeBarBG = new AttachedSprite('timeBar');
		...
		if (PauseSubState.songName != null) {
			...
			precacheList.set(backend.utils.Paths.formatToSongPath(ClientPrefs.data.pauseMusic), 'music');
		}
...
/*
	...
	private function generateSong(dataPath:String):Void
	{
		...
		add(notes);
		notes.visible = !ClientPrefs.data.hideFullHUD;
	...
	private function generateStaticArrows(player:Int):Void
	{
		for (i in 0...4)
		{
			...
			var babyArrow:game.objects.StrumNote = new game.objects.StrumNote(ClientPrefs.data.middleScroll ? STRUM_X_MIDDLESCROLL : STRUM_X, strumLine.y, i, player);
	...
	override public function update(elapsed:Float)
	{
		...
		if(cpuControlled){
			...
			ClientPrefs.data.botplayStudio = false;
		}
	...
	function goodNoteHit(note:Note):Void
	{
		if (!note.wasGoodHit)
		{
			...
			{
				FlxG.sound.play(backend.utils.Paths.sound('hitsound'), ClientPrefs.data.hitsoundVolume);
			}
