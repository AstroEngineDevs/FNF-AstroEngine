...
class ModsMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		while (i < modsList.length)
		{
			...
			newMod.alphabet = new funkin.game.objects.Alphabet(0, 0, mods[i].name, true);
	...
	override function update(elapsed:Float)
	{
		...
		if (canExit && controls.BACK)
		{
			...
			if (needaReset)
			{
				...
				funkin.game.states.TitleState.initialized = false;
				funkin.game.states.TitleState.closedState = false;
				FlxG.sound.music.fadeOut(0.3);
				if (funkin.game.states.FreeplayState.vocals != null)
				{
					funkin.game.states.FreeplayState.vocals.fadeOut(0.3);
					funkin.game.states.FreeplayState.vocals = null;
				}
...
class ModMetadata
{
	...
	public function new(folder:String)
	{
		...
		this.color = funkin.game.states.ModsMenuState.defaultColor;
		this.restart = false;
