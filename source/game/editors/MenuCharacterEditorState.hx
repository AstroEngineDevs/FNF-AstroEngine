...
class MenuCharacterEditorState extends MusicBeatState
{
	...
	override function create() {
		...
		tipText.setFormat(backend.utils.Paths.font("vcr.ttf"), 16, FlxColor.WHITE, CENTER);
	...
	function reloadSelectedCharacter() {
		...
		char.alpha = 1;
		char.frames = backend.utils.Paths.getSparrowAtlas('menucharacters/' + characterFile.image);
