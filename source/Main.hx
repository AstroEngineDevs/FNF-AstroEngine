...
class Main extends Sprite
{
	...
	public function new()
	{
		...
		addChild(new FlxGame(game.width, game.height, states.TitleState, #if (flixel < "5.0.0") game.zoom, #end game.framerate, game.framerate, game.skipSplash, game.startFullscreen));
